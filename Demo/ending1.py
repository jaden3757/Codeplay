...
def maprun():
    ...
    bgimg = pygame.image.load('images/ending1.png')
    ...
    while run:
        ...
        if im == 0:
            ...
            prtextm2('SPACE를 눌러서 끝내기', 30, 500, 500, (255,255,255), ft='pixel.ttf')
        if im == 1:
            prtextm2('Moon Side', 100, 500, 300, (255,255,255, True), ft='moon.otf')
        if fade > 0:
